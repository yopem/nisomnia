      ...
      <div className="space-y-3">
        <div className="rounded border border-border p-4">
            ...
            <div className="flex flex-row space-x-2">
              {user?.image ? (
                <Image
                  src={user?.image}
                  alt={user?.name!}
                  className="!relative !size-14 max-w-full rounded-full border-2 border-border object-cover shadow"
                />
              ) : (
                <Icon.User className="size-[100px] rounded-full border-2 border-border bg-muted/60 object-cover p-2 text-foreground/80 shadow" />
              )}
          ...
          <div className="mt-3 flex items-center justify-center text-sm">
            <Icon.Calendar className="mr-0 size-3" />
            <p className="text-xs">
